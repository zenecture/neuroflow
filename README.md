...
libraryDependencies ++= Seq(
  "com.zenecture" %% "neuroflow-core" % "0.803",
  "com.zenecture" %% "neuroflow-application" % "0.803"
)
...
Where `t` is the target vector and `net(x)` the predicted one. The sum is taken over all observations and the square gives a convex functional form.
